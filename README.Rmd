...
<!-- badges: start -->
[![R-CMD-check](https://github.com/arnops/tatooheene/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/arnops/tatooheene/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
Once available on CRAN, you can install the released version with:
